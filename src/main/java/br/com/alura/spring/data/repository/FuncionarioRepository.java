...
public interface FuncionarioRepository extends PagingAndSortingRepository<Funcionario, Integer>{
	...
	@Query(value = "SELECT * FROM funcionarios f WHERE f.data_contratação >= :data", nativeQuery = true)
	List<Funcionario> findDataDeContratacaoMaior(LocalDate data);
